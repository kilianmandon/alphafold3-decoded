...
class CalculateBondMatrix(Transform):
    """
    Calculates the bond matrix of shape (n_tokens n_tokens 1). The bond matrix is a binary matrix that has
    ...
    def forward(self, data):
        ...
        """
        TODO: Construct bond_matrix. Note the specifics: Only entries i<j are set to 1, and only if either 
        ...
        bond_matrix = bond_matrix[..., None]

        """ End of your code """

        data["bond_matrix"] = bond_matrix.astype(np.float32)
