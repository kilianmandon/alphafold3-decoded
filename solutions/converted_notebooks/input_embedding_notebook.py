...
ttr.TensorTrace('data/tensortraces/input_embedding', mode='write', framework='pytorch').start_trace()
...
print('Token-level BlockMask AttentionPairBias tests created.')
...
print('Diffusion transformer tests created.')
...
print('Forward index tests created.')
...
print('Inverse indices tests created.')
...
print('broadcast_up tests created.')
...
print('SingleAtomConditioning and AtomPairConditioning tests created.')
...
print('AtomAttentionEncoder and InputEmbedder tests created.')
...
print('AtomAttentionDecoder tests created.')
