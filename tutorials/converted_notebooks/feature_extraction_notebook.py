...
if success: print('Contact matrix tests passed.')
...
if success: print('Ref struct feature calculation (without unknown entries) tests passed.')
...
if success: print('Ref struct feature calculation (with unknown entries) tests passed.')
